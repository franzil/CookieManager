...
namespace CookieManager
{
   ...
   /// </summary>
   public class DefaultCookieManager(ICookie cookie) : ICookieManager
   {
      private readonly ICookie _cookie = cookie;
      ...
      public void Set(string key, object value, int? expireTime = default)
      {
